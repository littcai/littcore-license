...
public class JIpAddressField extends JComponent implements SwingConstants {  
	  ...
	  * ***************************************************************** 
	  */  
	 private JTextField txtCompart1 = new JTextField();  
	 private JTextField txtCompart2 = new JTextField();  
	 private JTextField txtCompart3 = new JTextField();  
	 ...
	 private void initGUI() {  
	  ...
	  final TableLayout layout = new TableLayout(new double[][]{{TableLayout.FILL,3,TableLayout.FILL,3,TableLayout.FILL,3,TableLayout.FILL},{TableLayout.PREFERRED}});
	   ...
	   * ***************************************************************** 
	   */  
	  //Font font = TranSwingFactory.getFont();  
	...
	//  txtCompart3.setPreferredSize(compartSize);  
	 ...
	 // txtDigital4.setPreferredSize(new Dimension(width, height));  
	  ...
	  this.add(txtDigital1,"0,0,f,c");  
	  this.add(txtCompart1,"1,0,f,c");  
	  this.add(txtDigital2,"2,0,f,c");  
	  this.add(txtCompart2,"3,0,f,c");  
	  this.add(txtDigital3,"4,0,f,c");  
	  this.add(txtCompart3,"5,0,f,c");  
	  this.add(txtDigital4,"6,0,f,c");  
