 ...
 *@since 2013-01-15
 */
public class VersionTextField extends JTextField
{
    private String st1 = "";
    private String st2 = "";
    private String st3 = "";
    ...
    public VersionTextField(String version)
    {
        super();
        analyzeStr(version);
        InitIPField();
        ...
        t1.setPrevNextComponent(t3,t2);
        t2.setPrevNextComponent(t1,t3);
        t3.setPrevNextComponent(t2,t3);
