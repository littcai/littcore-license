...
public class TableLayout implements LayoutManager2, VTabLayoutConstants {
     ...
     *            col1, col2, ..., colN}列宽像素, {row0, row1, row2, ..., rowM}行宽像素} If this
     *            parameter is invalid, the VTabLayout will have exactly one row
     *            and one column.
     *            <br>举例: 
     *            <br>new double[][]{ {5,20,TableLayout.FILL,5},{5,TableLayout.FILL} }
     *            <br>4列2行的表格：
     *            <br>第一列宽5像素，第2列20像素，第3列根据容器大小自动填充，第4列5个像素
     *            <br>第1行5像素，第2行自动充满
     *            <br>
     *            <br>备注：行列的序号从0开始，比如2表示是第3行/列
     *            <br>
     *            <br>组件如何放入表格中：
     *            <br>panel.add(ipAddrTextField, "1,1,3,f"); //2列，2行，占3列(列跨2-4列)，行填满
     *            <br>
     *            <br>另外，第三四个参数除了表示跨几行列外，里面还有对齐方式，列有：l(eft),r(ight),c(enter),f(ill-填充），行有：t(op),b(ottom),c(enter),f(ill)
     */
